...
import { homepageCardChromeClass, homepageSoftShadowClass } from "@/lib/homePageCardChrome"
...
export function HomeSmartSuggestionsSection() {
  ...
  return (
    <section
      className={cn(
        "flex min-w-0 flex-col gap-4 rounded-[var(--radius)] p-[18px]",
    ...
    >
      ...
      {/* Dark scrolling cards — unchanged */}
